...
library.getThemeConfig = function(config, callback) {
	meta.settings.get('persona', function(err, settings) {
		...
		config.hideTopicLastReply = settings.hideTopicLastReply === 'on';
		config.enableReplyAsTopic = settings.enableReplyAsTopic === 'on';
		config.enableUserInfo = settings.enableUserInfo === 'on';
		config.enableCategoryStatTopic = settings.enableCategoryStatTopic === 'on';
